...
const Header = () => {
    ...
    const authList = [
        {
            name: '마이페이지',
            link_key: `/manager/${user ? 'dashboards' : ''}`
        },
    ]
        ...
        <>
            ...
            {loading ?
                ...
                <>
                    ...
                    >
                        <TopMenuContainer>
                            <img src={logoSrc()} style={{ maxWidth: '120px', maxHeight: '64px', cursor: 'pointer' }}
                                onClick={() => {
                                    router.push('/shop')
                                }}
                            />
                        ...
                        <div style={{ borderBottom: `1px solid ${themeMode == 'dark' ? '#000' : theme.palette.grey[300]}` }} />
